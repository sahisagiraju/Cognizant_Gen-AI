...
def calculates_results_stats(results_dic):
    ...
    """        
    # results stats dictionary initialization
    ...
    for key in results_dic:
        # classifier and pet labels match
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1
        # pet label states image is a dog
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1
            # classifier agrees that the image is a dog (correct)
            if results_dic[key][4] == 1:
                results_stats_dic['n_correct_dogs'] += 1
            # match between classifier and pet labels implies that the breed must be correct, knowing that the pet is indeed a dog
            if results_dic[key][2] == 1:
                results_stats_dic['n_correct_breed'] += 1
        else:
            # classifier agrees that the image isn't a dog (correct)
